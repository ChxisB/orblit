package dev.orblit.orblit_gallery
 ...
 * `ORBLIT_EXAMPLE`, `ORBLIT_YAW`, and the rest of the dozens main.dart's own
 * header comment lists -- and the native core's own `getenv()` reads
 * (`ORBLIT_DUMP_FRAME`, `ORBLIT_BACKEND`, `ORBLIT_PACE`) work on Android exactly
 ...
 *
 * Example: `adb shell am start -n dev.orblit.orblit_gallery/.MainActivity
