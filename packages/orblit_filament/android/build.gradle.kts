...
val orblitFilamentSetup =
    tasks.register<Exec>("orblitFilamentSetup") {
...
val orblitGeneratedSet = System.getenv("ORBLIT_GENERATED_SET") ?: "android-release"

android {
    namespace = "dev.orblit.filament"
        ...
        externalNativeBuild {
            cmake {
                ...
                arguments += listOf(
                    ...
                    "-DORBLIT_GENERATED_SET=$orblitGeneratedSet",
                )
            }
        }
...
afterEvaluate {
    tasks
        ...
        .configureEach { dependsOn(orblitFilamentSetup) }
}
