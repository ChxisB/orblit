...
/* ---- A mesh handed over as bytes ----
 *
 * A cube as orblit_mesh writes one, 1732 bytes of binary glTF, embedded here
 * so the test needs no file and no download. */
static const uint8_t kCubeGlb[] = {
    ,
    ...
    0x43, 0x33, 0x22, 0x2c, 0x22, 0x6d, 0x69, 0x6e, 0x22, 0x3a, 0x5b, 0x2d,
    0x30, 0x2e, 0x35, 0x2c, 0x30, 0x2c, 0x2d, 0x30, 0x2e, 0x35, 0x5d, 0x2c,
    0x22, 0x6d, 0x61, 0x78, 0x22, 0x3a, 0x5b, 0x30, 0x2e, 0x35, 0x2c, 0x31,
    0x2c, 0x30, 0x2e, 0x35, 0x5d, 0x7d, 0x2c, 0x7b, 0x22, 0x62, 0x75, 0x66,
    ...
    0x79, 0x70, 0x65, 0x22, 0x3a, 0x22, 0x56, 0x45, 0x43, 0x32, 0x22, 0x7d,
    ...
    ,
    ...
    0x0f, 0x00, 0x00, 0x00, 0x13, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00,
    ...
    0x17, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xbf, 0x00, 0x00, 0x00, 0x00,
    ...
    0x00, 0x00, 0x00, 0xbf, 0x00, 0x00, 0x00, 0xbf, 0x00, 0x00, 0x80, 0x3f,
    ...
    0x00, 0x00, 0x00, 0x3f, 0x00, 0x00, 0x00, 0xbf, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x3f, 0x00, 0x00, 0x80, 0xbf, 0x00, 0x00, 0x00, 0x3f,
    0x00, 0x00, 0x80, 0xbf, 0x00, 0x00, 0x00, 0xbf, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0xbf, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3f,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xbf, 0x00, 0x00, 0x80, 0x3f,
    0x00, 0x00, 0x00, 0xbf, 0x00, 0x00, 0x80, 0x3f, 0x00, 0x00, 0x00, 0x3f,
    0x00, 0x00, 0x00, 0xbf, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xbf,
    0x00, 0x00, 0x80, 0xbf, 0x00, 0x00, 0x00, 0x3f, 0x00, 0x00, 0x80, 0xbf,
...
/* A mesh named before its bytes exist is reported missing, and loads once
 * they are provided — without the scene having to name anything new. That is
 * the order a host that fetches assets meets them in. */
static void mesh_loads_from_bytes(void) {
  ...
  expect(renderer != NULL, "a renderer for the mesh starts");
  if (renderer == NULL) return;

  static const char *const kName = "orblit:resource/test/cube.glb";
  const int64_t key = 1;
  ...
  const char *paths[1] = {kName};

  expect(orblit_renderer_apply_objects(renderer, 1, &key, identity, 16, grey, 3,
                                      &mesh, &flags, &material, &morphs,
                                      &weight, 0, paths, 1) == ORBLIT_OK,
         "an object can name a mesh nobody has provided yet");
  for (int frame = 0; frame < 3; frame++) {
    orblit_renderer_draw(renderer, frame / 60.0);
  }
  expect(noted(renderer, "cube.glb"),
         "a mesh that is not there yet is reported missing");

  expect(orblit_renderer_provide_resource(kName, kCubeGlb, sizeof kCubeGlb) ==
             ORBLIT_OK,
         "the mesh can be provided as bytes");
  expect(orblit_renderer_apply_objects(renderer, 1, &key, identity, 16, grey, 3,
                                      &mesh, &flags, &material, &morphs,
                                      &weight, 0, paths, 1) == ORBLIT_OK,
         "and the same scene stated again");
  for (int frame = 3; frame < 8; frame++) {
    orblit_renderer_draw(renderer, frame / 60.0);
  }
  expect(!noted(renderer, "cube.glb"),
         "a mesh provided after it was asked for is found, not remembered "
         "as missing");

  orblit_renderer_release_resource(kName);
...
int main(void) {
  ...
  /* And its own again, because it watches what the notes say. */
  mesh_loads_from_bytes();
