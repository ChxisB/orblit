...
/// [OrblitObject] is a thing the renderer keeps track of: it has a key, it is
...
enum OrblitFade {
  ...
  /// The member does not change at all. [OrblitPopulation.range] still stops
