...
class OrblitStep {
  const OrblitStep(this.mesh, this.until);
...
class OrblitLod {
  const OrblitLod(this.steps, {this.hysteresis = 0.1});
...
class OrblitDetailState {
  ...
  String? meshFor(int key, OrblitLod lod, Vector3 at, Vector3 camera) {
