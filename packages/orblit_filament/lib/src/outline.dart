...
enum OrblitOccluded {
  ...
  /// Drawn at [OrblitOutline.occludedOpacity].
  faint,

  /// Faint, and broken into dashes [OrblitOutline.dash] pixels long.
  dashed,
...
///
/// Only [OrblitScene.objects] can be outlined. A population is drawn in one
...
class OrblitOutline {
  const OrblitOutline({
    ...
    this.width = 2,
    this.occluded = OrblitOccluded.dashed,
    this.occludedOpacity = 0.4,
    this.dash = 6,
  });

  /// Nothing outlined.
  static const none = OrblitOutline();
  ...
  /// The objects outlined, by [OrblitObject.key]. Keys the scene does not
