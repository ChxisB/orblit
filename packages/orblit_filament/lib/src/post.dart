...
class OrblitPostProcess {
  OrblitPostProcess({
    this.enabled = true,
    this.antiAliasing = AntiAliasing.fxaa,
    OrblitBloom? bloom,
    OrblitDepthOfField? depthOfField,
    OrblitVignette? vignette,
    OrblitOcclusion? occlusion,
    OrblitReflections? reflections,
    OrblitGrading? grading,
    this.dithering = true,
  }) : bloom = bloom ?? OrblitBloom(),
       depthOfField = depthOfField ?? OrblitDepthOfField(),
       vignette = vignette ?? OrblitVignette(),
       occlusion = occlusion ?? OrblitOcclusion(),
       reflections = reflections ?? OrblitReflections(),
       grading = grading ?? OrblitGrading();
  ...
  final OrblitBloom bloom;
  final OrblitDepthOfField depthOfField;
  final OrblitVignette vignette;
  final OrblitOcclusion occlusion;
  final OrblitReflections reflections;
  final OrblitGrading grading;
