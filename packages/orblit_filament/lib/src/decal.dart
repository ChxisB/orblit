...
import 'material.dart' show OrblitTexture;
...
class OrblitDecal {
  ...
  ///
  /// Read as colour, always: whatever [OrblitTexture.srgb] says, a decal's
  ...
  /// Which layers receive it, as [OrblitObject.layer] numbers — null for every
  /// layer.
  ///
  /// Objects that share one [OrblitMaterial] share one shader instance, so
  ...
  ///
  /// The layout is written out in OrblitDecals.h, which is what reads it.
