...
// Orblit gives every placeholder cube its own material instance (the colour is
...
//  * An object wearing a named Orblit material already shares that material's
...
/// decides when Orblit goes to the trouble of making them share.
