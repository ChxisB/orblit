...
// and, under `#if !ORBLIT_PLATFORM_APPLE`, the portable answers to the rest.
// OrblitPlatformApple.mm answers those on Apple platforms.
...
void log(const char *format, ...) {
  ...
  va_start(arguments, format);
#if defined(__ANDROID__)
  __android_log_vprint(ANDROID_LOG_INFO, "orblit", format, arguments);
#else
