...
// up. `pluginClass: OrblitFilamentPlugin` in pubspec.yaml makes the tool
// write, into the runner's generated_plugin_registrant.cc,
//
//     #include <orblit_filament/orblit_filament_plugin.h>
//     orblit_filament_plugin_register_with_registrar(registrar);
//
...
// private to linux/ and reached through the `orblit_filament` method channel,
...
FLUTTER_PLUGIN_EXPORT void orblit_filament_plugin_register_with_registrar(
