...
import 'package:orblit_core/native.dart' as core;
import 'package:orblit_core/orblit_core.dart';

/// What a script may call back into, laid out exactly as `orblit_script.h`
/// declares it.
///
...
final class OrblitScriptHost extends Struct {
  @Uint32()
  external int abi;
  ...
  external Pointer<core.OrblitWorldStruct> world;
  ...
  external Pointer<
    NativeFunction<
      Uint32 Function(
        Pointer<core.OrblitWorldStruct>,
        Pointer<Char>,
        Uint32,
        Uint32,
      )
  ...
  external Pointer<
    NativeFunction<
      Uint32 Function(Pointer<core.OrblitWorldStruct>, Pointer<Char>)
    >
  >
  componentLookup;

  external Pointer<
    NativeFunction<Uint64 Function(Pointer<core.OrblitWorldStruct>)>
  >
  entityCreate;
  external Pointer<
    NativeFunction<Void Function(Pointer<core.OrblitWorldStruct>, Uint64)>
  >
  entityDestroy;
  external Pointer<
    NativeFunction<Bool Function(Pointer<core.OrblitWorldStruct>, Uint64)>
  >
  entityAlive;
  external Pointer<
    NativeFunction<Uint32 Function(Pointer<core.OrblitWorldStruct>)>
  >
  entityCount;
  external Pointer<
    NativeFunction<
  ...
  external Pointer<
    NativeFunction<
      Bool Function(Pointer<core.OrblitWorldStruct>, Uint64, Uint32)
    >
  >
  entityRemove;
  external Pointer<
  ...
  external Pointer<
    NativeFunction<
      Pointer<Void> Function(Pointer<core.OrblitWorldStruct>, Uint64, Uint32)
    >
  >
  entityGet;
  ...
  external Pointer<
    NativeFunction<
      Pointer<core.OrblitQueryStruct> Function(
        Pointer<core.OrblitWorldStruct>,
        Pointer<Uint32>,
        Uint32,
      )
  ...
  queryCreate;
  external Pointer<
    NativeFunction<Void Function(Pointer<core.OrblitQueryStruct>)>
  >
  queryDestroy;
  external Pointer<
    NativeFunction<Uint32 Function(Pointer<core.OrblitQueryStruct>)>
  >
  queryChunkCount;
  external Pointer<
    NativeFunction<Uint32 Function(Pointer<core.OrblitQueryStruct>, Uint32)>
  >
  queryChunkLength;
  external Pointer<
    NativeFunction<
      Pointer<Void> Function(Pointer<core.OrblitQueryStruct>, Uint32, Uint32)
    >
  >
  queryChunkColumn;
  external Pointer<
    NativeFunction<
      Pointer<Uint64> Function(Pointer<core.OrblitQueryStruct>, Uint32)
    >
  >
  queryChunkEntities;
  ...
  external Pointer<
    NativeFunction<
      core.OrblitTransformsStruct Function(Pointer<core.OrblitWorldStruct>)
    >
  >
  transformRegister;
...
class ScriptHost {
  ...
  final Pointer<OrblitScriptHost> _table = calloc<OrblitScriptHost>();
  ...
  Pointer<OrblitScriptHost> get pointer {
