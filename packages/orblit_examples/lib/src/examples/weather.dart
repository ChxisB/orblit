...
class WeatherExample extends Example {
  ...
  static final _shapes =
      <String, OrblitClouds Function({double cover, Vector2? wind})>{
        'Cumulus': OrblitClouds.cumulus,
        'Stratocumulus': OrblitClouds.stratocumulus,
        'Stratus': OrblitClouds.stratus,
        'Cirrus': OrblitClouds.cirrus,
        'Cumulonimbus': OrblitClouds.cumulonimbus,
      };
  ...
  void apply(String name) {
    ...
    if (name == 'Storm') {
      shape = 'Cumulonimbus';
      cloudAltitude = OrblitClouds.cumulonimbus().altitude;
    }
  }
...
precipitation: OrblitPrecipitation(
  amount: 0.65,
