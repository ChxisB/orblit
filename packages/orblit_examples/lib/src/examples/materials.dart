...
class MaterialsExample extends Example {
  ...
  OrblitBlend blend = OrblitBlend.transparent;
  double alpha = 0.45;
  ...
  Future<void> _draw() async {
    final directory = Directory(
      '${Directory.systemTemp.path}/orblit_gallery_materials',
    );
  ...
  static const List<(OrblitBlend, String, Color)> _blends = [
    (OrblitBlend.opaque, 'Opaque', Color(0xFFB9C2CC)),
    (OrblitBlend.transparent, 'Glass', Color(0xFF7FC7E8)),
    (OrblitBlend.fade, 'Fade', Color(0xFFD98FA8)),
    (OrblitBlend.masked, 'Masked', Color(0xFF9CD97F)),
    (OrblitBlend.add, 'Additive', Color(0xFFE8A24F)),
  ];
    ...
    materials.add(
      OrblitMaterial(
        ...
        baseColourMap: textured && _albedo != null
            ? OrblitTexture(_albedo!)
            : null,
        normalMap: textured && _normals != null
            ? OrblitTexture(_normals!, srgb: false)
            : null,
        metallicRoughnessMap: textured && _packed != null
            ? OrblitTexture(_packed!, srgb: false)
            : null,
      ...
      materials.add(
        OrblitMaterial(
          ...
          baseColour: Vector4(
            ...
            linear.y,
            linear.z,
            mode == OrblitBlend.opaque || mode == OrblitBlend.masked
                ? 1.0
                : alpha,
          ),
          roughness: 0.15,
          ...
          depthWrite: mode != OrblitBlend.add,
          emissiveIntensity: mode == OrblitBlend.add ? 2.0 : 0.0,
          emissive: mode == OrblitBlend.add ? linear : null,
          ...
          maskThreshold: 0.5,
          tiling: mode == OrblitBlend.masked ? Vector2(2, 2) : Vector2(1, 1),
          baseColourMap: mode == OrblitBlend.masked && _cutout != null
              ? OrblitTexture(_cutout!)
              : null,
        ),
      );
      objects.add(
