...
class DistortionExample extends Example {
  ...
  OrblitObject _box(int key, Vector3 at, Vector3 half, Color colour) =>
      OrblitObject(
        key: key,
...
OrblitScene(
  distortions: [
    ...
    OrblitDistortion.lens(strength: 0.1),  // barrel; negative is pincushion
  ],
  ...
)
''';
