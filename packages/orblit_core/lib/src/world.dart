...
class Chunk {
  ...
  final Pointer<native.OrblitQueryStruct> _query;
  final int _index;
...
class World {
  World() : _world = native.worldCreate() {
    if (_world == nullptr) {
      throw StateError('Could not create an Orblit world.');
    }
  }

  Pointer<native.OrblitWorldStruct> _world;
  ...
  TransformComponents registerTransforms() {
    ...
    return TransformComponents(
      local: ComponentType(
        id: ids.local,
        name: 'orblit.LocalTransform',
        kind: ComponentKind.float32,
        arity: 10,
      ),
      world: ComponentType(
        id: ids.world,
        name: 'orblit.WorldTransform',
        kind: ComponentKind.float32,
        arity: 16,
      ),
  ...
  Pointer<native.OrblitWorldStruct> get nativeHandle => _alive;

  Pointer<native.OrblitWorldStruct> get _alive {
