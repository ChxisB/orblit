package dev.orblit.spike.filament_surface

/**
 * The JNI surface of liborblit_spike.so, and nothing else.
 *
 ...
 * `dev.orblit.spike.filament_surface.SpikeRenderer` becomes
 * `Java_dev_orblit_spike_filament_1surface_SpikeRenderer_`, because JNI escapes
...
internal object SpikeRenderer {
    init {
        System.loadLibrary("orblit_spike")
    }
